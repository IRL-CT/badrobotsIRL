...
# "Original dataframe Binary Label Distribution:"
# print(label_balance(df, "binary_label"))

# "Original dataframe Multiclass Label Distribution:"
# print(label_balance(df, "multiclass_label"))


df_curated = pd.read_csv("preprocessing/curated_features/curated_features_dataset_v3.csv")

"Curated dataframe Binary Label Distribution:"
print(label_balance(df_curated, "binary_label"))

"Curated dataframe Multiclass Label Distribution:"
print(label_balance(df_curated, "multiclass_label"))
